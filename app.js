...
app.post('/upload', upload.fields([
    ...
    const { heading, semiHeading, content1, content2, content3, content4, category, subcategory } = req.body;
  ...
  app.get('/courses/:category/:subcategory/:id', (req, res) => {
    ...
    let query = 'SELECT * FROM courses WHERE category = ? AND subcategory = ? AND id = ?';
